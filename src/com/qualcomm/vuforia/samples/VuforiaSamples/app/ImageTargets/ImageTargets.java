...
import com.example.graffititv.R;
import com.example.graffititv.WallPresentation;
    ...
    SampleAppMenuInterface
{
	...
	private Point mPresDisplaySize;
	 ...
	 * current screen is disabled. Otherwise a new {@link SamplePresentation} is
	 * initialized and shown on the secondary screen.
	 */
	private void updatePresentation() {
		...
		if (selectedRoute != null) {
			...
			if (selectedRoute.getPresentationDisplay() != null) // detect if a
																...
																// enabled
			{
				...
				mPresDisplaySize = new Point();
				selectedDisplay.getSize(mPresDisplaySize);
				WallPresentation wp = new WallPresentation(this, selectedDisplay);
				wp.show();
				
			}
			// String description = (String) selectedRoute.getDescription();
    ...
    private void loadTextures()
    {
    	...
    	//mattf: this second array item seems to be necessary and is the texture that is overlayed on the teapot
